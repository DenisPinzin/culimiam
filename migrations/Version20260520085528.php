 ...
 */
final class Version20260520085528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE dosage (id INT AUTO_INCREMENT NOT NULL, dosage INT NOT NULL, recette_id INT NOT NULL, INDEX IDX_1E3ECAA189312FE9 (recette_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
