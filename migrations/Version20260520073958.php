 ...
 */
final class Version20260520073958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE typerepas (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(50) NOT NULL, couleur VARCHAR(30) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
